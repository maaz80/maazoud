...
export default function ProductDetailPage() {
      ...
      try {
        ...
        if (prodData) {
          ...
          if (relRes.data && relRes.data.length > 0) {
            ...
            // Pad related products up to 4 if category match contains fewer than 4 items
            ...
            // Fetch any 4 random products if overlaps query returned nothing
  ...
  // Calculate pricing based on selected size (3ml and 6ml only)
  let currentPrice = 0;
  ...
  // Reviews Slicing and page calculation
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3 md:space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="space-y-4 w-full">
            ...
            {/* FAQ section for Desktop (md and above) */}
          ...
          <div className="space-y-6">
            ...
            {/* Price section (Dynamically calculated based on size) */}
            ...
            {/* Pure Notes info */}
            {/* <div className="p-4 bg-stone-50 rounded-md border border-stone-100 space-y-2 text-xs text-stone-500 font-light">
              <p className="font-bold text-stone-700">Purity Guarantee</p>
              <p>Our attars are 100% alcohol-free, premium distillations designed for skin compatibility and long-lasting scent performance.</p>
            </div> */}

            {/* Product Description after Guarantee */}
        ...
        <section className="border-t border-stone-200 pt-12 grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Write a Review Alert and Button */}
                ...
                <div key={rev.id} className="pt-6 first:pt-0 space-y-3">
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-stone-100 border border-stone-200 text-stone-700 font-bold flex items-center justify-center text-xs">
        ...
        {/* Blogs Section (above mobile FAQ, bottom of PC page content) */}
        <BlogsSection />

        {/* FAQ section for Mobile (below md) */}
