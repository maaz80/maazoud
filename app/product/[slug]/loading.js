...
export default function ProductLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 font-sans bg-white min-h-screen animate-pulse">
      {/* Breadcrumbs Skeleton */}
      <div className="h-4 w-36 bg-stone-200 rounded mb-8" />
